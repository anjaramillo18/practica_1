...
${OBJECTDIR}/ejercicio_1.o: ejercicio_1.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -std=c11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ejercicio_1.o ejercicio_1.c

${OBJECTDIR}/ejercicio_10.o: ejercicio_10.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -std=c11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ejercicio_10.o ejercicio_10.c

${OBJECTDIR}/ejercicio_1_9.o: ejercicio_1_9.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -std=c11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ejercicio_1_9.o ejercicio_1_9.c

${OBJECTDIR}/ejercicio_2.o: ejercicio_2.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -std=c11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ejercicio_2.o ejercicio_2.c

${OBJECTDIR}/ejercicio_3.o: ejercicio_3.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -std=c11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ejercicio_3.o ejercicio_3.c

${OBJECTDIR}/ejercicio_4.o: ejercicio_4.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -std=c11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ejercicio_4.o ejercicio_4.c

${OBJECTDIR}/ejercicio_5.o: ejercicio_5.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -std=c11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ejercicio_5.o ejercicio_5.c

${OBJECTDIR}/ejercicio_6.o: ejercicio_6.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -std=c11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ejercicio_6.o ejercicio_6.c

${OBJECTDIR}/ejercicio_7.o: ejercicio_7.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -std=c11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ejercicio_7.o ejercicio_7.c

${OBJECTDIR}/ejercicio_8.o: ejercicio_8.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -std=c11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ejercicio_8.o ejercicio_8.c

${OBJECTDIR}/ejercicio_9.o: ejercicio_9.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -std=c11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ejercicio_9.o ejercicio_9.c
...
${OBJECTDIR}/radio.o: radio.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -std=c11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/radio.o radio.c
